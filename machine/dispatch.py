...
class EventDispatcher:
    ...
    def start(self):
        ...
        self._client.rtm_client.on("message")(lambda client, event: self.handle_message(client, event))
        self._client.start()
    ...
    def _dispatch_listeners(self, listeners: List[Dict[str, Any]], event: Dict[str, Any]):
        for listener in listeners:
            ...
            if "subtype" in event and event["subtype"] == "message_changed" and not listener["handle_changed_message"]:
                continue
