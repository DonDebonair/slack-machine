...
class HelpPlugin(MachineBasePlugin):
    ...
    def help(self, msg):
        ...
        help_text += "\n\n".join([self._gen_class_help_text(cls, fn) for cls, fn in manual.items() if fn])
        msg.say(help_text)
    ...
    def robot_help(self, msg):
        ...
        help_text += "\n\n".join([self._gen_class_robot_help(cls, regexes) for cls, regexes in robot_manual.items()])
        msg.say(help_text)
