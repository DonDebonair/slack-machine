payload = {
    ...
    "container": {
        "type": "message",
        "message_ts": "1715371664.874619",
        "channel_id": "CQEUMSV7D",
        "is_ephemeral": False,
    },
    "trigger_id": "7094314991846.842445099040.3b802b5be0c5fd32acf8c2b315ac2ba0",
    ...
    "message": {
        ...
        "blocks": [
            ...
            },
            {
                ...
                "hint": {"type": "plain_text", "text": "Choose a channel...", "emoji": True},
                "optional": False,
                "dispatch_action": False,
                "element": {"type": "multi_channels_select", "action_id": "select_channel"},
            },
            {"type": "divider", "block_id": "3r4GK"},
            {
                "type": "actions",
    ...
    "state": {
        "values": {
            ...
            "channel_select": {
                "select_channel": {"type": "multi_channels_select", "selected_channels": ["CQS7DP10C", "CQSLXBJP2"]}
            },
        }
    },
    "response_url": "https://hooks.slack.com/actions/TQSD32X16/7123736364672/xmncnAR8vyWxncVBu6tfkq8p",
    "actions": [
        {
            "type": "multi_channels_select",
            "action_id": "select_channel",
            "block_id": "channel_select",
            "selected_channels": ["CQS7DP10C", "CQSLXBJP2"],
            "action_ts": "1715371669.732559",
        }
    ],
}
