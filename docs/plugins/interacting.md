...
:   An instance of the [`Message`][machine.plugins.base.Message] class is automatically supplied to your plugin
...
It is recommended to use the passed-in [`Message`][machine.plugins.base.Message] object to interact with channels
...
[`msg.reply()`][machine.plugins.base.Message.reply] will start the reply with a mention of the sender of the
original message.
...
[`msg.reply()`][machine.plugins.base.Message.reply] will use the [Slack WebAPI](https://api.slack.com/web) to send
...
There is 1 more method to respond to a message in the same channel: [`msg.say()`][machine.plugins.base.Message.say]
...
[`msg.reply_dm()`][machine.plugins.base.Message.reply_dm] methods. This will open a DM convo between the sender of
...
These behave similar to their [`Message`][machine.plugins.base.Message] counterparts, except that they require a
...
[`Message`][machine.plugins.base.Message] object [`@respond_to`][machine.plugins.decorators.respond_to] and
