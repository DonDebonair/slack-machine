payload = {
    ...
    "trigger_id": "7093332165398.842445099040.c0c87f6a1b23949758a3cb845f32ba51",
    ...
    "response_url": "https://hooks.slack.com/actions/TQSD32X16/7097054223925/V9zzmH33CCApEYIn9l8fjlab",
    "actions": [
        {
            "action_id": "select_radio_option",
            "block_id": "radio_demonstration",
            "selected_option": {"text": {"type": "plain_text", "text": "Disagree", "emoji": True}, "value": "4"},
            "type": "radio_buttons",
            "action_ts": "1715360149.835609",
        }
    ],
}
