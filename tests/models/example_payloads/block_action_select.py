payload = {
    ...
    "trigger_id": "7102459401924.842445099040.e8d07ec409bb6aee5271ced8f4487782",
    ...
    "response_url": "https://hooks.slack.com/actions/TQSD32X16/7122776759568/veQdwQLRKk9bWJ2KPW2U3q9E",
    "actions": [
        {
            "type": "static_select",
            "action_id": "select_menu_options",
            "block_id": "alphabet",
            "selected_option": {"text": {"type": "plain_text", "text": "BBBB", "emoji": True}, "value": "B"},
            "action_ts": "1715360381.098191",
        }
    ],
}
