...
def test_import_all_classes():
    ...
    assert 'FakeA' in classes_dict
    assert inspect.isclass(classes_dict['FakeA'])
    assert classes_dict['FakeA'].__name__ == 'FakeA'
    assert 'FakeB' in classes_dict
    assert inspect.isclass(classes_dict['FakeB'])
    assert classes_dict['FakeB'].__name__ == 'FakeB'
