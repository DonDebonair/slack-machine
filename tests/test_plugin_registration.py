...
def test_load_and_register_plugins(settings):
    ...
    assert 'class' in actions['respond_to']['tests.fake_plugins.FakePlugin.respond_function-hello']
    assert 'function' in actions['respond_to']['tests.fake_plugins.FakePlugin.respond_function-hello']
    assert 'regex' in actions['respond_to']['tests.fake_plugins.FakePlugin.respond_function-hello']
    assert actions['respond_to']['tests.fake_plugins.FakePlugin.respond_function-hello']['regex'] == re.compile('hello', re.IGNORECASE)
    ...
    assert 'class' in actions['listen_to']['tests.fake_plugins.FakePlugin.listen_function-hi']
    assert 'function' in actions['listen_to']['tests.fake_plugins.FakePlugin.listen_function-hi']
    assert 'regex' in actions['listen_to']['tests.fake_plugins.FakePlugin.listen_function-hi']
    assert actions['listen_to']['tests.fake_plugins.FakePlugin.listen_function-hi']['regex'] == re.compile('hi', re.IGNORECASE)
